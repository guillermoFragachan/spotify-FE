...
import { getLikedAlbums } from "../store/actions/index";
...
function Album() {
  ...
  const _liked = likedAlbums.find(
    (liked) => liked.id.toString() === params.toString()
  );
          ...
          <div>
            <div className="buttons-row">
              ...
              {_liked ? (
                ...
                width="32"
                viewBox="0 0 32 32"
                onClick={() => addAlbumToFavourite(albumInfo)}
              >
